...
namespace WeatherApi.Models
{
    ...
    public class Utility
    {
        ...
        public const string SERVER_NOTFOUND = "The resource(s) you are looking for is not available, please try again or contact us if the issue persist.";
